...
@WebAppConfiguration
public class DeleteUserToGraphTest {
    ...
    @Test
    public void deleteUserToGraphTest1() throws Exception {
    ...
    @Test
    public void deleteUserToGraphTest2() throws Exception {
    	MvcResult m = mockMvc.perform(get("/deleteUserToGraph?name=vale&session=" + session.substring(2) + "&graph=http://exampleTest.com/ng1"))
                .andExpect(content().contentType(TestUtil.APPLICATION_JSON_UTF8))
    ...
    //Test invalid rol
    @Test
    public void deleteUserToGraphTest3() throws Exception {
    	//change rol
